...
async def list_batches(
    ...
    *,
    ...
    if search:
        ...
        filters.append(
            or_(
                ...
                ProductBatch.product.has(Product.name.ilike(pattern)),
                ProductBatch.product.has(Product.sku.ilike(pattern)),
            )
        )
    ...
    statement = select(ProductBatch).where(*filters).order_by(order_by, ProductBatch.id.asc())
